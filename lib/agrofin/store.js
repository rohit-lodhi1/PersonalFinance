...
export function StoreProvider({ children }) {
  ...
  }), [token, me, managingUser, managingUserId, activeUserId, data, add, update, remove, addLoanTx, removeLoanTx, updateLoanTx, addCropInvestment, updateCropInvestment, removeCropInvestment, setBudget, login, logout, authError, loading, users, refreshUsers, createUser, patchUser, deleteUser, manageAs])
